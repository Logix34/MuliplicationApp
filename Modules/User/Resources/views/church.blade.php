                    ...
                    <div class="nk-block-head nk-block-head-lg">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">INFORMATION OF THE AREA WHERE THE NEW CHURCH WILL BE PLANTED</h4>
                            </div>
                            ...
                            <form method="post" action="{{ route('user.profile.update') }}">
                                ...
                                <div class="data-item">
                                    <div class="data-col">
                                        ...
                                        <input type="text" name="area_address" class="form-control" value="{{ $user->area_address }}">
                                    </div>
                                </div><!-- data-item -->
                                <div class="data-item">
                                    <div class="data-col">
                                        <span class="data-label">City</span>
                                        <input type="text" name="area_city" class="form-control" value="{{ $user->area_city }}">
                                    </div>
                                </div><!-- data-item -->
                                <div class="data-item">
                                    <div class="data-col">
                                        <span class="data-label">State</span>
                                        <input type="text" name="area_state" class="form-control" value="{{ $user->area_state }}">
                                    </div>
                                </div><!-- data-item -->
                                <div class="data-item">
                                    <div class="data-col">
                                        <span class="data-label">Country</span>
                                        <input type="text" name="area_country" class="form-control" value="{{ $user->area_country }}">
                                    </div>
                                </div><!-- data-item -->
                        ...
                        <div class="card-inner p-0">
                            <ul class="link-list-menu">
                                ...
                                @else
                                    ...
                                    <li><a class="active" href="{{ route('user.church') }}"><em class="icon ni ni-user-fill-c"></em><span>Church Information</span></a></li>
